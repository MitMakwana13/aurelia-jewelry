  ...
  return (
    <div className="w-full md:w-64 shrink-0">
      ...
      <nav className="flex md:flex-col gap-6 md:gap-4 overflow-x-auto pb-4 md:pb-0 border-b md:border-b-0 border-border">
        <Link 
          href="/account/orders" 
          className={`text-xs uppercase tracking-[0.15em] whitespace-nowrap transition-colors ${pathname === "/account/orders" ? "text-ink font-medium" : "text-ink/60 hover:text-ink"}`}
        >
          Orders
        </Link>
        <Link 
