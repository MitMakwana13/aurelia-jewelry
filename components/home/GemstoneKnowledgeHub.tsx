...
const articles = [
  {
    ...
    description: "Discover which gemstone aligns with your astrological chart to unlock prosperity and balance.",
  ...
  {
    title: "The Hidden Benefits",
    description: "Beyond their timeless beauty, explore the historical and metaphysical benefits of wearing pure cosmic stones.",
    ...
    <section ref={sectionRef} className="py-24 lg:py-32 bg-white">
      <div className="container-x">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          >
            <Link href="#" className="text-[10px] uppercase tracking-[0.2em] text-ink link-underline">
              View All Articles
            </Link>
          </motion.div>
        </div>
